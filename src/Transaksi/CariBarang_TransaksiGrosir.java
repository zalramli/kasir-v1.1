 ...
 * @author Lenovo
 */
public class CariBarang_TransaksiGrosir extends javax.swing.JFrame {

    /**
     * Creates new form CariBarang
     */
    public CariBarang_TransaksiGrosir() {
        initComponents();
        tampil_data();
        custom_tabel();
...
//        new DashboardKasir().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CariBarang_TransaksiGrosir.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
